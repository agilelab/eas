<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModuleInstaller.aspx.cs"
    Inherits="EAS.WebShell.Biz.ModuleInstaller" %>
...
<body>
        ...
        <rows>
            <f:FormRow ID="FormRow1" runat="server" ColumnWidths="70% 30%">
                <Items>
                    ...
                    <f:Button ID="btnRload" Text="加载" runat="server" Icon="Reload" 
                        OnClick="btnRload_Click">
                    </f:Button>
                </Items>
            </f:FormRow>
        </rows>
    ...
    <f:Grid ID="Grid2" Title="Grid2" AllowSorting="true" AllowPaging="false" BoxFlex="1"
        ShowHeader="False" runat="server" Height="300px" EnableCheckBoxSelect="True"
        DataKeyNames="Type,Assembly" SortField="Name" EnableRowLines="True" OnSort="Grid2_Sort">
        <toolbars>
        ...
        <columns>
            ...
            <f:BoundField Width="100px" SortField="Name" DataField="Name" HeaderText="名称" 
                ID="ctl49" ColumnID="Grid2_ctl49" />
            <f:BoundField Width="150px" SortField="Assembly" DataField="Assembly" 
                HeaderText="程序集" ID="ctl50" ColumnID="Grid2_ctl50" />
            <f:BoundField Width="240px" DataField="Description" HeaderText="说明" ID="ctl51" 
                ColumnID="Grid2_ctl51" />
        </columns>
    </f:Grid>    
    </form>
</body>

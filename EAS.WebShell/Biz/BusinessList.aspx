<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessList.aspx.cs" Inherits="EAS.WebShell.Biz.BusinessList" %>
            ...
            <f:Grid ID="Grid2" Title="Grid2" PageSize="15" ShowBorder="true" BoxFlex="1" AllowPaging="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" runat="server">
                        <Items>
                            <f:Button ID="btnInstall" Text="安装构件" runat="server" Icon="New">
                            </f:Button>
                ...
                <Columns>
                    ...
                    <f:BoundField Width="150px" SortField="Method" DataField="Method" HeaderText="方法" />
                    ...
                    <f:WindowField TextAlign="Center" Width="35px" WindowID="Window1" Icon="Pencil" ToolTip="业务构件编辑"
                        DataIFrameUrlFields="Guid" DataIFrameUrlFormatString="~/Biz/BusinessWindow.aspx?guid={0}"
                        Title="编辑业务构件" IFrameUrl="~/alert.aspx" />
                    <f:LinkButtonField TextAlign="Center" Width="35px" Icon="Delete" ToolTip="卸载" ConfirmText="确定卸载业务构件？"
                    ...
                    <f:BoundField Width="100px" DataField="LMTime" DataFormatString="{0:yyyy-MM-dd}"
                        HeaderText="更新时间" />
                    <f:BoundField Width="240px" DataField="Guid" HeaderText="模块ID" />                    
                </Columns>
            </f:Grid>
        </Items>
    </f:Panel>

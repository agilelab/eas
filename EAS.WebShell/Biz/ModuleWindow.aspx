<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModuleWindow.aspx.cs" Inherits="EAS.WebShell.Biz.ModuleWindow" %>
                            ...
                            <f:Tab ID="Tab2" Title="安全" BodyPadding="5px" runat="server">
                                <Items>
                                    <f:Grid ID="Grid2" Title="Grid2" ShowBorder="true" BoxFlex="1" AllowPaging="false"
                                        ...
                                        Height="235px" DataKeyNames="PObject,Privileger,PType" IsDatabasePaging="true"

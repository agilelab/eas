...
{
    [EAS.Modularization.Module("E7066EA4-F3C4-46AB-B424-570A58A18CFA", "函数管理", "函数是系统之中的自定义权限功能点,用于按钮级别的权限")]
    public partial class FunctionList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                this.btnNew.OnClientClick = Window2.GetShowReference("~/Biz/FunctionNew.aspx", "新建函数");
                this.BindGrid();
            }
        }
        ...
        private int GetTotalCount()
        {
            ...
            int type = (int)GoComType.Function;

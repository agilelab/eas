...
void Page_Load(Object sender, EventArgs e)
{
    ...
    string simage = Request.QueryString["rs:image"];

    if (simage != null)
    {
        _DoHtml = false;
        byte[] ba = _Viewer.GetImage(simage);
        if (ba == null)
        {
        ...
        {
            Response.ContentType = _Viewer.GetImageType(simage);
...
<!-- Beginning of list directory  -->   
 <table> 
 <tr><td><a href="" onclick="return false;"><span onclick="setReport('ChartExampleArea.rdl');" >ChartExampleArea</span></a></td></tr>
 <tr><td><a href="" onclick="return false;"><span onclick="setReport('ChartExampleAreaPercentStacked.rdl');" >ChartExampleAreaPercentStacked</span></a></td></tr>
 <tr><td><a href="" onclick="return false;"><span onclick="setReport('ChartExampleAreaStacked.rdl');" >ChartExampleAreaStacked</span></a></td></tr>
 <tr><td><a href="" onclick="return false;"><span onclick="setReport('ChartExampleBar.rdl');" >ChartExampleBar</span></a></td></tr>
 <tr><td><a href="" onclick="return false;"><span onclick="setReport('DrilldownTest.rdl');" >DrilldownTest</span></a></td></tr>
 </table> 

					...
					switch (l.Layout)
					{
						...
						case LegendLayoutEnum.Table:
                            ...
                            g.DrawString(c, drawFont, drawBrush, rect, drawFormat);
                                ...
                                { DrawLegendBox(g, GetSeriesBrush(rpt, 1, iCol), cm, x + 1, y, boxSize); }
...
// 20022008 AJM GJL
        ...
        {
            Brush br = SeriesBrush[col - 1];            // this will be the default brush
        ...
        Brush GetSeriesBrushesPatterned(int i)
        {
            ...
            switch (i % 10)
            {
                case 0:
                    ...
                    break;
                case 1:
                    PatternBrush = new HatchBrush(HatchStyle.Weave, Color.Red, Color.White);
                    break;
                case 2:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    PatternBrush = new HatchBrush(HatchStyle.Wave, Color.Gold, Color.White);
                    break;
                case 8:

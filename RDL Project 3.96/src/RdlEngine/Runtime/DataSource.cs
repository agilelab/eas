...
namespace fyiReporting.RDL
{
	...
	public class DataSource
	{
        ...
        public bool GetConnectionOK()
        {
            string _DataProvider = this._dsd.ConnectionProperties.DataProvider;
            string _Connectstring = this._dsd.ConnectionProperties.Connectstring(_rpt);

            if ((_DataProvider.Length > 0) & (_Connectstring.Length > 0))
            {
                return true;
            }
            else

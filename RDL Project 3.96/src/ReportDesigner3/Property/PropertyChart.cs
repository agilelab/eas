...
namespace fyiReporting.RdlDesign
{
    ...
    /// </summary>
    public class PropertyChart : PropertyDataRegion
    {
    ...
    public class PropertyChartAxis : IReportItem
    {
        PropertyChart _pt;
        string _Axis;
    ...
    public class PropertyChartData : IReportItem
    {
        PropertyChart _pt;
...
#region IReportItem Members
    ...
    public class PropertyChartGridLines : IReportItem
    {
        PropertyChart _pt;
        string[] _names;
    ...
    public class PropertyChartLegend : IReportItem
    {
        PropertyChart _pt;
    ...
    public class PropertyChartTitle : IReportItem
    {
        PropertyChart _pt;
        string[] _subitems;
        string[] _names;
    ...
    internal class ChartTypeConverter : StringConverter
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(new string[] {
                                    "Column", "Bar", "Line", "Pie", "Area", "Doughnut", "Bubble", "Scatter"});
        }
    }
    #endregion
    #region PaletteType
    internal class PaletteTypeConverter : StringConverter
    {
        ...
        {
            return new StandardValuesCollection(new string[] {
               "Default", "EarthTones", "Excel", "GrayScale", "Light", "Pastel", "SemiTransparent","Patterned","PatternedBlack"});
        }
    }
    #endregion

    public enum LineStyleEnum { Solid, Dotted, Dashed };
}

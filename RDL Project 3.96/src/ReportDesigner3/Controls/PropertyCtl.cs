...
namespace fyiReporting.RdlDesign
{
	...
	internal class PropertyCtl : System.Windows.Forms.UserControl
	{
        ...
        private void SetPropertyNames()
        {
            ...
            {
                cbReportItems.Items.Add("*Report*");
            ...
            else
            {
                try
                {
                    cbReportItems.Items.Remove("*Group Selection*");
                }
                catch { }
                try
                {
                    cbReportItems.Items.Remove("*Unnamed*");
                }
                catch { }
            }
        }
		...
		private void InitializeComponent()
		{
            ...
            this.cbReportItems.Size = new System.Drawing.Size(240, 20);
        ...
        {
            MDIDesigner rd = this.Parent as MDIDesigner;
            if (rd == null)
                return;

...
namespace fyiReporting.RdlDesign
{
	...
	{ 
		...
		{
			// EDIT MENU
			menuCopy = new MenuItem("复制(&C)", new EventHandler(this.menuCopy_Click));
			menuPaste = new MenuItem("粘贴", new EventHandler(this.menuPaste_Click));
			menuDelete = new MenuItem("删除(&D)", new EventHandler(this.menuDelete_Click));
			menuFSep1 = new MenuItem("-");
			menuSelectAll = new MenuItem("选择全部(&A)", new EventHandler(this.menuSelectAll_Click));
			menuFSep2 = new MenuItem("-");

            List<MenuItem> insertItems = new List<MenuItem>();
            insertItems.Add(new MenuItem("图表...", new EventHandler(this.menuInsertChart_Click)));
            insertItems.Add(new MenuItem("图像", new EventHandler(this.menuInsertImage_Click)));
            insertItems.Add(new MenuItem("线", new EventHandler(this.menuInsertLine_Click)));
			insertItems.Add(new MenuItem("列表", new EventHandler(this.menuInsertList_Click)));
			insertItems.Add(new MenuItem("矩阵...", new EventHandler(this.menuInsertMatrix_Click)));
            insertItems.Add(new MenuItem("矩形", new EventHandler(this.menuInsertRectangle_Click)));
            insertItems.Add(new MenuItem("字报表", new EventHandler(this.menuInsertSubreport_Click)));
            insertItems.Add(new MenuItem("表格...", new EventHandler(this.menuInsertTable_Click)));
            insertItems.Add(new MenuItem("文本框", new EventHandler(this.menuInsertTextbox_Click)));

            BuildContextMenusCustom(insertItems);

			menuInsert = new MenuItem("&插入");
			menuInsert.MenuItems.AddRange(insertItems.ToArray());

			menuProperties = new MenuItem("属性(&P)...", new EventHandler(this.menuProperties_Click));

			//
			// Create chart context menu and add array of sub-menu items
			menuPropertiesLegend = new MenuItem("联想...", new EventHandler(this.menuPropertiesLegend_Click));
			menuPropertiesCategoryAxis = new MenuItem("栏目 (X) 轴...", new EventHandler(this.menuPropertiesCategoryAxis_Click));
            menuPropertiesValueAxis = new MenuItem("值 (Y) 轴...", new EventHandler(this.menuPropertiesValueAxis_Click));

            menuPropertiesCategoryAxisTitle = new MenuItem("栏目 (X) 轴标题...", new EventHandler(this.menuPropertiesCategoryAxisTitle_Click));
            menuPropertiesValueAxisTitle = new MenuItem("值 (Y) 轴标题...", new EventHandler(this.menuPropertiesValueAxisTitle_Click));
            menuPropertiesValueAxis2Title = new MenuItem("值 (Y) 轴(Right)标题...", new EventHandler(this.menuPropertiesValueAxis2Title_Click));
			menuPropertiesChartTitle = new MenuItem("标题...", new EventHandler(this.menuPropertiesChartTitle_Click));
		...
		private void DrawPanelContextMenuChart(Point p, XmlNode riNode)
		{
			...
			MenuItem menuChartInsertCategoryGrouping = new MenuItem("插入栏目分组...", 
				new EventHandler(this.menuChartInsertCategoryGrouping_Click));
			MenuItem menuChartEditCategoryGrouping = new MenuItem("修改栏目分组");
            MenuItem menuChartDeleteCategoryGrouping = new MenuItem("删除改栏目分组");
			...
			MenuItem menuChartInsertSeriesGrouping = new MenuItem("插入序列分组...", new EventHandler(this.menuChartInsertSeriesGrouping_Click));
            MenuItem menuChartEditSeriesGrouping = new MenuItem("修改序列分组");
            MenuItem menuChartDeleteSeriesGrouping = new MenuItem("删除序列分组");
		...
		private void DrawPanelContextMenuMatrix(Point p, XmlNode riNode)
		{
			...
			menuContext.Popup +=new EventHandler(this.menuContext_Popup);
			// matrix menus
			MenuItem menuMatrixDelete = new MenuItem("删除矩阵", new EventHandler(this.menuMatrixDelete_Click));
            MenuItem menuMatrixProperties = new MenuItem("矩阵属性...", new EventHandler(this.menuMatrixProperties_Click));
			...
			MenuItem menuMatrixInsertColumnGroup = new MenuItem("插入列分组...", new EventHandler(this.menuMatrixInsertColumnGroup_Click));
            MenuItem menuMatrixEditColumnGroup = new MenuItem("修改列分组");
            MenuItem menuMatrixDeleteColumnGroup = new MenuItem("删除列分组");
            ...
            MenuItem menuMatrixInsertRowGroup = new MenuItem("插入行分组...", new EventHandler(this.menuMatrixInsertRowGroup_Click));
            MenuItem menuMatrixEditRowGroup = new MenuItem("修改行分组");
            MenuItem menuMatrixDeleteRowGroup = new MenuItem("删除行分组");
		...
		private void DrawPanelContextMenuTable(Point p, XmlNode riNode)
		{
			...
			menuContext.Popup +=new EventHandler(this.menuContext_Popup);
			// table menus
			MenuItem menuTableInsertRowBefore = new MenuItem("在上方插入行", new EventHandler(this.menuTableInsertRowBefore_Click));
			MenuItem menuTableInsertRowAfter = new MenuItem("在下方插入行", new EventHandler(this.menuTableInsertRowAfter_Click));
			MenuItem menuTableDeleteRow = new MenuItem("删除行", new EventHandler(this.menuTableDeleteRow_Click));
			MenuItem menuTableInsertColumnBefore = new MenuItem("在左侧插入列", new EventHandler(this.menuTableInsertColumnBefore_Click));
			MenuItem menuTableInsertColumnAfter = new MenuItem("在右侧插入列", new EventHandler(this.menuTableInsertColumnAfter_Click));
			MenuItem menuTableInsertTableGroup = new MenuItem("插入分组...", new EventHandler(this.menuTableInsertGroup_Click));
			MenuItem menuTableDeleteColumn = new MenuItem("删除列", new EventHandler(this.menuTableDeleteColumn_Click));
			MenuItem menuTableDelete = new MenuItem("删除表", new EventHandler(this.menuTableDelete_Click));
			MenuItem menuTableProperties = new MenuItem("表属性...", new EventHandler(this.menuTableProperties_Click));

			// the replace items
			MenuItem menuReplTextbox = new MenuItem("文本框(&T)", new EventHandler(this.menuInsertTextbox_Click));
            MenuItem menuReplRectangle = new MenuItem("矩形(&R)", new EventHandler(this.menuInsertRectangle_Click));
			MenuItem menuReplImage = new MenuItem("图像(&I)", new EventHandler(this.menuInsertImage_Click));
			MenuItem menuReplSubreport = new MenuItem("子报表(&S)", new EventHandler(this.menuInsertSubreport_Click));
			MenuItem menuReplList = new MenuItem("列表(&L)", new EventHandler(this.menuInsertList_Click));
            MenuItem menuReplMatrix = new MenuItem("矩阵(&M)...", new EventHandler(this.menuInsertMatrix_Click));
			MenuItem menuReplTable = new MenuItem("表格(B)...", new EventHandler(this.menuInsertTable_Click));
			MenuItem menuReplChart = new MenuItem("图表(&C)...", new EventHandler(this.menuInsertChart_Click));
			MenuItem menuRepl = new MenuItem("&替换单元格");
			...
			{
				MenuItem menuTableEditGroup= new MenuItem("修改分组");
				MenuItem menuTableDeleteGroup= new MenuItem("删除分组");
		...
		private bool DrawPanelMouseDownInsert(HitLocation hl, object sender, MouseEventArgs e)
		{
				...
				_MouseDownNode.Name == "PageFooter")))
			{
				if (_CurrentInsert == null || _CurrentInsert == "Line" || hl == null || 
						hl.HitContainer == null || hl.HitContainer.Name != "Table")
				   return false;
		...
		private void menuPaste_Click(object sender, EventArgs e)
		{
			...
			{
				if (hl.HitContainer != null && hl.HitContainer.Name == "Table")
				{
		...
		private void doSelectAll()
		{
			...
			{
				if (riNode.Name == "Table" || riNode.Name == "List" || riNode.Name == "Rectangle")

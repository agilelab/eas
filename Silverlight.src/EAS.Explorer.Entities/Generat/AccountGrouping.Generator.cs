...
{
   /// <summary>
   /// 实体对象 AccountGrouping(帐户分组)。
   /// </summary>
   [Serializable()]
   [Table("EAS_ACCOUNTGROUPING"),Index]
   partial class AccountGrouping: DataEntity<AccountGrouping>
   {
       public AccountGrouping()
       {
       }
       
       protected AccountGrouping(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 角色名称 。
       /// </summary>
       [Column("ROLENAME","角色名称"),PrimaryKey]
       public string RoleName
       {
           get
           {
               return this.GetValue<string> ("ROLENAME");
           }
           set
           {
               this["ROLENAME"] = value;

...
{
   /// <summary>
   /// 实体对象 WFInstanceState(流程持久化)。
   /// </summary>
   [Serializable()]
   [Table("WF_InstanceState","流程持久化")]
   partial class WFInstanceState: DataEntity<WFInstanceState>
   {
       public WFInstanceState()
       {
       }
       
       protected WFInstanceState(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 实例ID 。
       /// </summary>
       [Column("InstanceId", "实例ID"), DataSize(36), PrimaryKey]
       ...
       /// 序列化信息 。
       /// </summary>
       [Column("Info","序列化信息",DbType.Binary),DataSize(512)]
       public byte[] Info
       {
           get;
           set;

...
namespace EAS.Explorer.Entities
{
   ...
   /// </summary>
   [Serializable()]
   [Table("EAS_VARIABLES","内部变量定义")]
   partial class Variable: DataEntity<Variable>, IDataEntity<Variable>
   {
       public Variable()
       {
       ...
       /// 变量Guid 。
       /// </summary>
       [Column("GUID","变量Guid"),DataSize(36)]
       [DisplayName("变量Guid")]
       public string Guid
       {
           get;
       ...
       /// 名称 。
       /// </summary>
       [Column("NAME","名称"),DataSize(128),PrimaryKey]
       [DisplayName("名称")]
       public string Name
       {
           get;

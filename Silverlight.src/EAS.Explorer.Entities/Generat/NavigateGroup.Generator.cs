...
{
    /// <summary>
    /// 实体对象 NavigateGroup(导航分组)。
    /// </summary>
    [Serializable()]
    [Table("EAS_GROUPS", "导航分组")]
    partial class NavigateGroup : DataEntity<NavigateGroup>
    {
        public NavigateGroup()
        {
        }

        protected NavigateGroup(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// 分组名称 。
        /// </summary>
        [Column("NAME", "分组名称"), DataSize(64), PrimaryKey]
        [AutoUI(Width = 80, Alignment = UIAlignment.Left)]
        public string Name
        {
            get;
        ...
        /// 上级ID 。
        /// </summary>
        [Column("PARENTID", "上级ID"), DataSize(36), PrimaryKey]
        [AutoUI(Width = 80, Alignment = UIAlignment.Left)]
        ...
        /// 流程图 。
        /// </summary>
        [Column("WFModule", "流程图"), DataSize(64)]
        [AutoUI(Width = 80, Alignment = UIAlignment.Left)]

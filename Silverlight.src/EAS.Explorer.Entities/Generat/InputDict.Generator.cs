...
namespace EAS.Explorer.Entities
{
    ...
    /// </summary>
    [Serializable()]
    [Table("EAS_INPUTDICT", "输入字典")]
    partial class InputDict : DataEntity<InputDict>
    {
        public InputDict()
        {
        }

        protected InputDict(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// 字典ID 。
        /// </summary>
        [Column("InputID", "字典ID"), DataSize(36), PrimaryKey]

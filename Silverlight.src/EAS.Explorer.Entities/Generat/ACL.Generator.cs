...
namespace EAS.Explorer.Entities
{
    ...
    /// </summary>
    [Serializable()]
    [Table("EAS_ACL", "访问控制列表")]
    partial class ACL : DataEntity<ACL>
    {
        public ACL()
        {
        }

        protected ACL(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        /// 模块/功能 。
        /// </summary>
        [Column("POBJECT", "模块/功能"), DataSize(36), PrimaryKey]
        ...
        /// 权限所有者 。
        /// </summary>
        [Column("PRIVILEGER", "权限所有者"), DataSize(64), PrimaryKey]
        [AutoUI(Width = 80, Alignment = UIAlignment.Left)]
        public string Privileger
        {
            get;
            set;
        }
        ...
        /// 所有者类型 。
        /// </summary>
        [Column("PTYPE", "所有者类型"), DataSize(10)]
        [AutoUI(Width = 80, Alignment = UIAlignment.Left)]
        public int PType
        {
            get;

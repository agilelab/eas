...
namespace EAS.Explorer.Entities
{
   ...
   /// </summary>
   [Serializable()]
   [Table("EAS_LOGS", "登录日志记录"), Index]
   partial class Log: DataEntity<Log>
   {
       public Log()
       {
       }
       ...
       [AutoUI(Width = 240, Index = 10, Alignment = UIAlignment.Left)]
       public string ID
       {
           get
           {
       ...
       [AutoUI(Width = 130, Index = 0, Alignment = UIAlignment.Center, Format = "yyyy-MM-dd HH:mm:ss")]
       public DateTime EventTime
       {
           get
           {
               return this.GetValue<DateTime>("EVENTTIME");
           }
           set
           {
       ...
       [AutoUI(Width = 100, Index = 1, Alignment = UIAlignment.Left)]
       ...
       [AutoUI(Width = 180, Index = 2, Alignment = UIAlignment.Left)]
       public string Event
       {
           get
           {
               return this.GetValue<string>("EVENT");
           }
           set
           {
               this["EVENT"] = value;
       ...
       [AutoUI(Width = 100, Index = 3, Alignment = UIAlignment.Left)]
       ...
       [AutoUI(Width = 100, Index = 4, Alignment = UIAlignment.Left)]

...
namespace EAS.Explorer.Entities
{
   ...
   /// </summary>
   [Serializable()]
   [Table("EAS_DESKTOPITEM","桌面定义"),Index]
   partial class DesktopItem: DataEntity<DesktopItem>
   {
       public DesktopItem()
       {
       }
       
       protected DesktopItem(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 模块GUID 。
       /// </summary>
       [Column("POBJECT","模块GUID"),DataSize(36),PrimaryKey]
       [AutoUI(Width=80,Alignment=UIAlignment.Left)]
       public string PObject
       {
           get
           {
               return this.GetValue<string> ("POBJECT");
           }
           set
           {
               this["POBJECT"] = value;
       ...
       public int Counter
       {
           get
           {
               return this.GetValue<int> ("COUNTER");
           }
           set
           {
               this["COUNTER"] = value;

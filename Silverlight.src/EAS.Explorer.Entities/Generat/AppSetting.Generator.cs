...
{
   /// <summary>
   /// 实体对象 AppSetting(系统参数)。
   /// </summary>
   [Serializable()]
   [Table("EAS_APPSETTINGS"),Index]
   partial class AppSetting: DataEntity<AppSetting>
   {
       public AppSetting()
       {
       }
       
       protected AppSetting(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 参数目录 。
       /// </summary>
       [Column("CATEGORY","参数目录"),PrimaryKey]
       ...
       /// 参数名称 。
       /// </summary>
       [Column("ITEMKEY","参数名称"),PrimaryKey]
       public string Key
       {
           get
           {
               return this.GetValue<string> ("ITEMKEY");
           }
           set
           {
               this["ITEMKEY"] = value;
       ...
       /// 参数值 。
       /// </summary>
       [Column("ITEMVALUE","参数值")]
       public string Value
       {
           get
           {
               return this.GetValue<string> ("ITEMVALUE");
           }
           set
           {

...
1、AgileEAS.NET SOA 5.2最新版本下载
      ...
      直接下载：AgileEAS.NET SOA 5.2 下载，http://139.186.28.27/downloads/eas/agileeas.net.5.rar。

      SVN更新：https://139.186.28.27/svn/eas/5.0，登录用户:eas，密码eas.
...
2、案例源代码-药店管理系统
      ...
      直接下载：AgileEAS.NET SOA  案例（药店管理系统）源码下载，http://139.186.28.27/downloads/eas/drugshop.rar。

      SVN更新：https://139.186.28.27/svn/drugshop，登录用户:eas，密码eas.
...
3、案例源代码-小型分销EPR系统
      ...
      直接下载：AgileEAS.NET SOA 5.0 案例（分诊ERP系统）源码下载，http://139.186.28.27/downloads/eas/smarterp.rar。

      SVN更新：https://139.186.28.27/svn/smarterp，登录用户:eas，密码eas.
...
4、案例源代码-Northwind
     ...
     直接下载：AgileEAS.NET SOA  案例（Northwind）源码下载，http://139.186.28.27/downloads/eas/Northwind.rar。
...
5、案例源代码-在线聊天室系统
      ...
      直接下载：AgileEAS.NET SOA 中间件平台Socket通信框架 案例（在线聊天室系统）源码下载，http://139.186.28.27/downloads/eas/Chat.src.rar。

      SVN更新：https://139.186.28.27/svn/chat，登录用户:eas，密码eas.

      源代码下载,请通过进行下载。

      同时，我们在服务器上部署好了一套可运行的案例，客户端下载：http://139.186.28.27/downloads/eas/examples/chat.client.rar。
...
8、视频会议培训下载
      ...
      第一辑-AgileEAS.NET平台介绍及药品系统的SAAS搭建演练：下载地址：http://139.186.28.27/downloads/video/AgileEAS.NET 4.0 Video1.rar

      第二辑-简单插件开发应用演练：下载地址：http://139.186.28.27/downloads/video/AgileEAS.NET 4.0 Video2.rar

      第三辑 插件的安装、配置以及账户权限系统演练.wmv http://139.186.28.27/downloads/video/AgileEAS.NET 4.0 Video3.rar
